...
var DataTable = (0, _coreDecorators.autobind)(_class = (_temp2 = _class2 = function (_Component) {
    ...
    function DataTable() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = DataTable.__proto__ || Object.getPrototypeOf(DataTable)).call.apply(_ref, [this].concat(args))), _this), _this.dataTable = null, _this.state = {
            data: [],
            current: 1,
            total: 0,
            config: {},
    ...
    _createClass(DataTable, [{
        ...
        value: function showDetailInfo(e, val) {
            e.stopPropagation();
            var container = this.dataTable.parentNode.getElementsByClassName('simple-info-container')[0];
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { className: 'data-table', ref: function ref(dataTable) {
                        return _this5.dataTable = dataTable;
                    } },
