...
var Select = (0, _coreDecorators.autobind)(_class = (_temp2 = _class2 = function (_Component) {
    ...
    function Select() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Select.__proto__ || Object.getPrototypeOf(Select)).call.apply(_ref, [this].concat(args))), _this), _this.selectInput = null, _this.state = {
            valueMap: {},
            showDropdown: false
    ...
    _createClass(Select, [{
        ...
        key: 'onSelect',
        value: function onSelect(val, label) {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                { ref: function ref(select) {
                        _this2.selectInput = select;
                    }, className: 'form-control select ' + (showDropdown ? "open" : ''), onClick: function onClick() {
                ...
                showDropdown ? _react2.default.createElement(
                    ...
                    newOptions.map(function (option, i) {
                        return _react2.default.createElement(
                            'li',
                            { onClick: function onClick(_) {
                                    _this2.onSelect(option.value, option.label);
                                }, key: i },
                            option.label
                        );
                    })
