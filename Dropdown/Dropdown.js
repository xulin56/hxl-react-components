...
var Dropdown = (0, _coreDecorators.autobind)(_class = (_temp2 = _class2 = function (_Component) {
    ...
    function Dropdown() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Dropdown.__proto__ || Object.getPrototypeOf(Dropdown)).call.apply(_ref, [this].concat(args))), _this), _this.dropDownHandler = null, _this.state = {
            open: false
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { ref: function ref(dropDownHandler) {
                            return _this2.dropDownHandler = dropDownHandler;
                        } },
                ...
                _react2.default.createElement(
                    ...
                    options.map(function (item, i) {
                        return _react2.default.createElement(
                            'li',
                            { key: i, className: "dropdown-li " + (item.disabled ? "disabled" : ""), style: { cursor: 'pointer' }, onClick: function onClick(_) {
